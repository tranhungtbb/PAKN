...
namespace PAKNAPI.ControllerBase
{
	...
	public class MRTableBaseController : BaseApiController
	{
		...
		#region MRRecommendationFullText

		[HttpGet]
		[Authorize("ThePolicy")]
		[Route("MRRecommendationFullTextGetByID")]
		public async Task<ActionResult<object>> MRRecommendationFullTextGetByID(long? Id)
		{
			try
			{
				return new ResultApi { Success = ResultCode.OK, Result = await new MRRecommendationFullText(_appSetting).MRRecommendationFullTextGetByID(Id) };
			}
			catch (Exception ex)
			{
				_bugsnag.Notify(ex);
		...
		[HttpGet]
		[Authorize("ThePolicy")]
		[Route("MRRecommendationFullTextGetAll")]
		public async Task<ActionResult<object>> MRRecommendationFullTextGetAll()
		{
			try
			{
				return new ResultApi { Success = ResultCode.OK, Result = await new MRRecommendationFullText(_appSetting).MRRecommendationFullTextGetAll() };
			}
			catch (Exception ex)
			{
				_bugsnag.Notify(ex);
		...
		[HttpGet]
		[Authorize("ThePolicy")]
		[Route("MRRecommendationFullTextGetAllOnPage")]
		public async Task<ActionResult<object>> MRRecommendationFullTextGetAllOnPage(int PageSize, int PageIndex)
		{
			try
			{
				List<MRRecommendationFullTextOnPage> rsMRRecommendationFullTextOnPage = await new MRRecommendationFullText(_appSetting).MRRecommendationFullTextGetAllOnPage(PageSize, PageIndex);
				IDictionary<string, object> json = new Dictionary<string, object>
					{
						{"MRRecommendationFullText", rsMRRecommendationFullTextOnPage},
						{"TotalCount", rsMRRecommendationFullTextOnPage != null && rsMRRecommendationFullTextOnPage.Count > 0 ? rsMRRecommendationFullTextOnPage[0].RowNumber : 0},
						{"PageIndex", rsMRRecommendationFullTextOnPage != null && rsMRRecommendationFullTextOnPage.Count > 0 ? PageIndex : 0},
						{"PageSize", rsMRRecommendationFullTextOnPage != null && rsMRRecommendationFullTextOnPage.Count > 0 ? PageSize : 0},
					};
				return new ResultApi { Success = ResultCode.OK, Result = json };
			}
			catch (Exception ex)
		...
		[HttpPost]
		[Authorize("ThePolicy")]
		[Route("MRRecommendationFullTextInsert")]
		public async Task<ActionResult<object>> MRRecommendationFullTextInsert(MRRecommendationFullText _mRRecommendationFullText)
		{
			try
			{
				new LogHelper(_appSetting).ProcessInsertLogAsync(HttpContext, null);

				return new ResultApi { Success = ResultCode.OK, Result = await new MRRecommendationFullText(_appSetting).MRRecommendationFullTextInsert(_mRRecommendationFullText) };
			}
			catch (Exception ex)
			{
				_bugsnag.Notify(ex);
		...
		[HttpPost]
		[Authorize("ThePolicy")]
		[Route("MRRecommendationFullTextListInsert")]
		public async Task<ActionResult<object>> MRRecommendationFullTextListInsert(List<MRRecommendationFullText> _mRRecommendationFullTexts)
		{
			try
			{
				int count = 0;
				int errcount = 0;
				foreach (MRRecommendationFullText _mRRecommendationFullText in _mRRecommendationFullTexts)
				{
					int? result = await new MRRecommendationFullText(_appSetting).MRRecommendationFullTextInsert(_mRRecommendationFullText);
					if (result != null)
					{
						count++;
					}
		...
		[HttpPost]
		[Authorize("ThePolicy")]
		[Route("MRRecommendationFullTextUpdate")]
		public async Task<ActionResult<object>> MRRecommendationFullTextUpdate(MRRecommendationFullText _mRRecommendationFullText)
		{
			try
			{
				int count = await new MRRecommendationFullText(_appSetting).MRRecommendationFullTextUpdate(_mRRecommendationFullText);
				if (count > 0)
				{
					return new ResultApi { Success = ResultCode.OK, Result = count };
				}
		...
		[HttpPost]
		[Authorize("ThePolicy")]
		[Route("MRRecommendationFullTextDelete")]
		public async Task<ActionResult<object>> MRRecommendationFullTextDelete(MRRecommendationFullText _mRRecommendationFullText)
		{
			try
			{
				int count = await new MRRecommendationFullText(_appSetting).MRRecommendationFullTextDelete(_mRRecommendationFullText);
				if (count > 0)
				{
					new LogHelper(_appSetting).ProcessInsertLogAsync(HttpContext, null);
		...
		[HttpPost]
		[Authorize("ThePolicy")]
		[Route("MRRecommendationFullTextListDelete")]
		public async Task<ActionResult<object>> MRRecommendationFullTextListDelete(List<MRRecommendationFullText> _mRRecommendationFullTexts)
		{
			try
			{
				int count = 0;
				...
				foreach (MRRecommendationFullText _mRRecommendationFullText in _mRRecommendationFullTexts)
				{
					var result = await new MRRecommendationFullText(_appSetting).MRRecommendationFullTextDelete(_mRRecommendationFullText);
					if (result > 0)
					{
						count++;
					}
		...
		[HttpPost]
		[Authorize("ThePolicy")]
		[Route("MRRecommendationFullTextDeleteAll")]
		public async Task<ActionResult<object>> MRRecommendationFullTextDeleteAll()
		{
			try
			{
				int count = await new MRRecommendationFullText(_appSetting).MRRecommendationFullTextDeleteAll();
				if (count > 0)
				{
					new LogHelper(_appSetting).ProcessInsertLogAsync(HttpContext, null);
		...
		#endregion MRRecommendationFullText
