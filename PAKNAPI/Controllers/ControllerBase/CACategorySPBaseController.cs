...
namespace PAKNAPI.ControllerBase
{
	...
	public class CACategorySPBaseController : BaseApiController
	{
		...
		public async Task<ActionResult<object>> CADepartmentGetAllOnPageBase(int? PageSize, int? PageIndex, string Name, string Code, string Description, bool? IsActived)
		{
			try
			{
				List<CADepartmentGetAllOnPage> rsCADepartmentGetAllOnPage = await new CADepartmentGetAllOnPage(_appSetting).CADepartmentGetAllOnPageDAO(PageSize, PageIndex, Name, Code, Description, IsActived);
				IDictionary<string, object> json = new Dictionary<string, object>
					{
		...
		public async Task<ActionResult<object>> CADepartmentGroupGetAllOnPageBase(int? PageSize, int? PageIndex, string Name, string Code, string Description, bool? IsActived)
		{
			try
			{
				List<CADepartmentGroupGetAllOnPage> rsCADepartmentGroupGetAllOnPage = await new CADepartmentGroupGetAllOnPage(_appSetting).CADepartmentGroupGetAllOnPageDAO(PageSize, PageIndex, Name, Code, Description, IsActived);
				IDictionary<string, object> json = new Dictionary<string, object>
					{
		...
		[HttpPost]
		[Authorize]
		[Route("CADepartmentGroupInsertListBase")]
		public async Task<ActionResult<object>> CADepartmentGroupInsertListBase(List<CADepartmentGroupInsertIN> _cADepartmentGroupInsertINs)
		{
			try
			{
				int count = 0;
				int errcount = 0;
				foreach (var _cADepartmentGroupInsertIN in _cADepartmentGroupInsertINs)
				{
					var result = await new CADepartmentGroupInsert(_appSetting).CADepartmentGroupInsertDAO(_cADepartmentGroupInsertIN);
					if (result > 0)
					{
						count++;
					}
		...
		public async Task<ActionResult<object>> CAHashtagGetAllOnPageBase(int? PageSize, int? PageIndex, string Name, string Code, bool? IsActived)
		{
			try
			{
				List<CAHashtagGetAllOnPage> rsCAHashtagGetAllOnPage = await new CAHashtagGetAllOnPage(_appSetting).CAHashtagGetAllOnPageDAO(PageSize, PageIndex, Name, Code, IsActived);
				IDictionary<string, object> json = new Dictionary<string, object>
					{
		...
		public async Task<ActionResult<object>> CAWordGetAllOnPageBase(int? PageSize, int? PageIndex, string Name, string Code, string Description, bool? IsActived)
		{
			try
			{
				List<CAWordGetAllOnPage> rsCAWordGetAllOnPage = await new CAWordGetAllOnPage(_appSetting).CAWordGetAllOnPageDAO(PageSize, PageIndex, Name, Code, Description, IsActived);
				IDictionary<string, object> json = new Dictionary<string, object>
					{
