...
export class StatisticService {
	...
	getProcessingResultByFeild(query: any): Observable<any> {
		return this.serviceInvoker.get(query, AppSettings.API_ADDRESS + Api.StatisticRecommendationProcessingResultsByFeild)
	}
