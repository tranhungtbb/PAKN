...
export class RecommendationRequestService {
	...
	recommendationGetDataForCreate(request: any): Observable<any> {
		...
		return this.serviceInvoker.getwithHeaders(request, AppSettings.API_ADDRESS + Api.RecommendationRequestGetDataForCreate, headers)
	}
	...
	recommendationGetListProcess(request: any): Observable<any> {
		...
		return this.serviceInvoker.getwithHeaders(request, AppSettings.API_ADDRESS + Api.RecommendationRequestGetListProcess, headers)
	}
	...
	recommendationGetFileByIdView(request: any): Observable<any> {
		let headers = {
			logAction: encodeURIComponent(LOG_ACTION.GETINFO),
			logObject: encodeURIComponent(LOG_OBJECT.CA_FIELD),
		}
		return this.serviceInvoker.getwithHeaders(request, AppSettings.API_ADDRESS + Api.RecommendationRequestGetFile, headers)
	}
