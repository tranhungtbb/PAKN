...
import * as ClassicEditor from '../../../../assets/dist/ckeditor5/build/ckeditor'
...
@Component({
	selector: 'app-support-public-for-app',
	templateUrl: './support-list-public-for-app.component.html',
	styleUrls: ['./support-list-public-for-app.component.css'],
})
export class SupportListPublicForAppComponent implements OnInit, AfterViewInit {
	constructor(
	...
	getAll() {
		this.supportService.GetListByType({ Type: TYPE_SUPPORT.APP }).subscribe(
			(res) => {
