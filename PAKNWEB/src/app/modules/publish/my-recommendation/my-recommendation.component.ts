...
export class MyRecommendationComponent implements OnInit {
	...
	mr_status: any = {
		'Chờ xử lý': [RECOMMENDATION_STATUS.RECEIVE_WAIT],
		'Đã tiếp nhận': [RECOMMENDATION_STATUS.RECEIVE_APPROVED, RECOMMENDATION_STATUS.PROCESS_WAIT, RECOMMENDATION_STATUS.PROCESSING, RECOMMENDATION_STATUS.APPROVE_WAIT],
		'Đã trả lới': [RECOMMENDATION_STATUS.FINISED],
		'Bị từ chối': [RECOMMENDATION_STATUS.PROCESS_DENY, RECOMMENDATION_STATUS.APPROVE_DENY, RECOMMENDATION_STATUS.RECEIVE_DENY],
	}
