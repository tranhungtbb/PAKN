...
@Component({
	selector: 'app-processing-recommendations',
	templateUrl: './processing-recommendations.component.html',
	styleUrls: ['./processing-recommendations.component.css'],
})
export class ProcessingRecommendationsComponent implements OnInit {
	// property
