...
@Component({
	selector: 'app-detail-recommendation-cttdt-public',
	templateUrl: './recommendations-cttdt-detail.component.html',
	styleUrls: ['./recommendations-cttdt-detail.component.css'],
})
export class DetailRecommendationCttdtComponent implements OnInit {
	id : any
	files : any = []
	APIADDRESS: any
	...
	getData() {
		...
		this.recommendationService.getCongThongTinDienTuTinhGetById(request).subscribe((response) => {
