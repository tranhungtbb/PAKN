...
@Component({
	selector: 'app-detail-recommendation-knct-public',
	templateUrl: './recommendation-knct-detail.component.html',
	styleUrls: ['./recommendation-knct-detail.component.css'],
})
export class DetailRecommendationKnctComponent implements OnInit {
	id : any
	files : any = []
	APIADDRESS: any
