...
declare var $: any
@Component({
	selector: 'app-statistic-processing-results-by-unit-and-reception',
	templateUrl: './processing-results-by-unit-and-reception.component.html',
	styleUrls: ['./processing-results-by-unit-and-reception.component.css'],
})
export class ProcessingResultsByUnitAndReceptionComponent implements OnInit {
	constructor(
