...
declare var $: any
@Component({
	selector: 'app-list-forward',
	templateUrl: './list-forward.component.html',
	styleUrls: ['./list-forward.component.css'],
})
export class ListForwardComponent implements OnInit {
	constructor(
	...
	getList() {
		...
		let request = {
			...
			Status: RECOMMENDATION_STATUS.FORWARD,
