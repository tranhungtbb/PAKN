...
@Component({
	selector: 'app-list-receive-deny',
	templateUrl: './list-receive-deny.component.html',
	styleUrls: ['./list-receive-deny.component.css'],
})
export class ListReceiveDenyComponent implements OnInit {
