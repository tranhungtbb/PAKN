...
@Component({
	selector: 'app-list-administrative-formalities',
	templateUrl: './list-administrative-formalities.component.html',
	styleUrls: ['./list-administrative-formalities.component.css'],
})
