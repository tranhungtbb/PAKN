...
export class DialogService {
	...
	constructor(private userService: UserServiceChatBox) {}
	...
	public joinToDialog(dialog): Promise<any> {
		return new Promise((resolve, reject) => {
			const jidOrUserId = dialog.xmpp_room_jid || dialog.jidOrUserId || this.userService.getRecipientUserId(dialog.occupants_ids)
