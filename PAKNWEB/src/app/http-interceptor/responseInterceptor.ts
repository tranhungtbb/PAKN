...
export class ResponseInterceptor implements HttpInterceptor {
  ...
  constructor(private _router: Router, private storeageService: UserInfoStorageService,
    private loadingService: LoadingIndicatorService, private toastr: ToastrService) { }
